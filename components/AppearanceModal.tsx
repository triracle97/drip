...
export default function AppearanceModal({
  ...
  const [mode, setMode] = useState<"emoji" | "icons">(
    icon.startsWith("svg:") ? "icons" : "emoji",
  );
  const [activeTab, setActiveTab] = useState(
    mode === "icons" ? "svg_utilities" : "entertainment",
  );
          ...
          <View style={s.preview}>
            ...
            <View>
              <Text style={s.previewName}>
                {name || t("appearance.subscription")}
              </Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={s.modeRow}>
              <TouchableOpacity
                style={[
                  s.modeBtn,
                  mode === "emoji" && { backgroundColor: selColor },
                ]}
                onPress={() => switchMode("emoji")}
                activeOpacity={0.7}
              >
                <Text
                  style={[s.modeTxt, mode === "emoji" && { color: "#fff" }]}
                >
                  {t("appearance.emoji")}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  s.modeBtn,
                  mode === "icons" && { backgroundColor: selColor },
                ]}
                onPress={() => switchMode("icons")}
                activeOpacity={0.7}
              >
                <Text
                  style={[s.modeTxt, mode === "icons" && { color: "#fff" }]}
                >
                  {t("appearance.icons")}
                </Text>
              </TouchableOpacity>
                ...
                ? activeIcons.map((ic) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        style={[
                          s.iconCell,
                          { backgroundColor: sel ? selColor : C.bgSub },
                        ]}
            ...
            {/* Color swatches */}
            <Text style={[s.sectionLabel, { marginTop: SP[1] }]}>
              {t("appearance.color")}
            </Text>

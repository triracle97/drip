...
export default function SubRow({
  ...
  if (variant === "trial") {
    ...
    return (
      ...
      >
        <View
          style={[s.stripe, { backgroundColor: isWhiteBg ? C.line : color }]}
        />
          ...
          <View style={s.rightCol}>
            ...
            <View style={[s.pill, { backgroundColor: `${C.red}18` }]}>
              <Text style={[s.pillText, { color: C.red }]}>
                {t("subRow.daysLeft", { count: trialDaysLeft })}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={s.cardInner}>
          ...
          <View style={{ flex: 1 }}>
            <Text
              style={[
                s.rowName,
                { textDecorationLine: "line-through", color: C.t2 },
              ]}
            >
              {name}
            </Text>
          </View>
          <Text style={{ fontSize: 13, color: C.t3, fontWeight: "500" }}>
            {t("subRow.wasCost", { cost: costLabel })}
          </Text>
        </View>
      </AnimatedPressable>
    );
      ...
      <View style={s.cardInner}>
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            {trialJustEnded && (
              <View style={s.trialEndedBadge}>
                <Text style={s.trialEndedBadgeText}>
                  {t("subRow.trialEnded")}
                </Text>
              </View>
            )}
        ...
        <View style={s.rightCol}>
          ...
          {renewLabel && (
            <View
              style={[
                s.pill,
                { backgroundColor: urgent ? urgentPillBg : normalPillBg },
              ]}
            >
